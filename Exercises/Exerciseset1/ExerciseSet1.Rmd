...
2. 
<br>
3. Update mytickers = c("SPY", "AAPL","YHOO")
<br>
<br>
...
<br>
2.
portfolio_transposedata = apply(transposedData,2,mean)
names(portfolio_transposedata) <- rownames(StockReturns)
pnl_plot(portfolio_transposedata)
<br>
